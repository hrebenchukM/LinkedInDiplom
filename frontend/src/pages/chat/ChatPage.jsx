...
export function ChatPage() {
  ...
  const activeProfile = useMemo(
    () => getContactProfile(activeChat?.peer || activeChat?.id, { name: activeChat?.peer }),
    [activeChat?.id, activeChat?.peer],
  );
        ...
        <section className="chat-col">
          <div className="chat-thread__head">
            <div className="chat-thread__person">
              ...
              />
              <div>
                <h1 className="chat-thread__name">{activeChat?.peer || t("chat.selectChat", "Select chat")}</h1>
        ...
        <aside className="chat-col chat-col--profile" ref={profileRef}>
          <div className="chat-profile">
            <img
              ...
              alt=""
            />
            <h2 className="chat-profile__name">{activeChat?.peer || t("chat.profile.none", "No contact selected")}</h2>
