  ...
  return (
    <>
      <div className="experience-section">
        <h2>{t('portfolio.experience.title', 'Experience')}</h2>
        ...
        <button className="show-more-button">{t('portfolio.showMore', 'Show more')}</button>
      </div>

      <div className="education-section">
        <h2>{t('portfolio.education.title', 'Education')}</h2>
          ...
          <div key={index} className="education-entry">
            ...
            <div className="education-details">
              ...
              <p className="education-degree">
                {t('portfolio.degreeIn', '{degree} in {field}', {
                  degree: item.education.degree,
                  field: item.education.fieldOfStudy,
                })}
              </p>
      ...
      <div className="certificates-section">
        <h2>{t('portfolio.certificates.title', 'Certificates and licenses')}</h2>
          ...
          <div key={index} className="certificate-entry">
            ...
            <div className="certificate-details">
              ...
              <p className="certificate-date">
                {t('portfolio.issued', 'Issued {date}', { date: item.certificate.issueDate })}
                {item.certificate.expiryDate &&
                  ` • ${t('portfolio.expiring', 'Expiring {date}', { date: item.certificate.expiryDate })}`}
              </p>
            </div>

            {item.certificate.downloadRef && (
              <button className="certificate-button">
                {t('portfolio.certificate', 'Certificate')}
              </button>
            )}
          </div>
        ))}
      ...
      <div className="recommendations-section">
        <h2>{t('portfolio.recommendations.title', 'Recommendations')}</h2>
      ...
      <div className="languages-section">
        <h2>{t('portfolio.languages.title', 'Languages')}</h2>
