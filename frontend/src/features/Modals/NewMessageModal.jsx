...
const NewMessageModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t('modal.newMessage.title', 'New message')}>
      <div>
        ...
        <div className="form-group">
          <input
            ...
            placeholder={t('modal.newMessage.search', 'Search people by name')}
            value={searchQuery}
        ...
        <div style={{ marginTop: '24px' }}>
          ...
          >
            {loading
              ...
              : searchQuery.trim()
                ? t('vac.searchResults', 'Results')
                : t('modal.newMessage.startTyping', 'Start typing to search')}
          </h3>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {!loading && searchQuery && results.length === 0 ? (
              <p style={{ color: '#6b7280' }}>{t('modal.newMessage.noResults', 'No people found')}</p>
            ) : null}
