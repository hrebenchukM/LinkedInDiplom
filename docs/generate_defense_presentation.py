...
SLIDES = [
    ...
    },
    {
        ...
        "right": [
            ...
            "API-клієнт, інтеграція з backend і E2E verify (17/17).",
        ],
    },
    {
        "type": "feature",
    ...
    },
    {
        ...
        "points": [
            ...
            "SignalR hub для realtime повідомлень; unread, archive, mute, delete, share posts.",
            "AI assistant session з quick prompts; VoiceCallOverlay — UI-демо дзвінків.",
            "Чати інтегровані з network: відкриття діалогу з картки контакту.",
        ],
    },
    {
        "type": "feature",
    ...
    },
    {
        ...
        "points": [
            "Пости завантажуються з content API; enrichPostsWithAuthors для імен і аватарів.",
            "Реакції, коментарі, share menu, PostViewRecorder — повний engagement flow.",
            "CreatePost modal з rich text і media; hashtags following panel.",
            "Стрічка оновлюється без reload через API + локальний state.",
        ],
    },
    {
        "type": "feature",
