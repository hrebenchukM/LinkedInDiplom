...
Вся документация проекта собрана в **одной папке `docs`** без подпапок.
...
10. `09_CONFIG_UPLOADS.md` — appsettings, env vars, CORS, uploads
...
Всего: **14** markdown-файлов в `docs`.
