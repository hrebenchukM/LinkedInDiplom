...
<!-- merged from: 05_CONFIGURATION_AND_UPLOADS.md -->
...
Docker: см. [06_INFRASTRUCTURE_AND_DEVELOPMENT.md](06_INFRASTRUCTURE_AND_DEVELOPMENT.md).
...
Подробно: [08_SEED_DATA.md](08_SEED_DATA.md).
...
Подробно: [05_CONFIGURATION_AND_UPLOADS.md](05_CONFIGURATION_AND_UPLOADS.md).
...
**EventSpeaker:** глобальный справочник без `OwnerId`; write + avatar — Admin-only; read — User JWT (см. `02_ARCHITECTURE_AND_MODULES.md`, `11_LIMITATIONS_AND_TODO.md`).
