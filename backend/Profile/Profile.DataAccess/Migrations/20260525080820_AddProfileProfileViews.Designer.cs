...
namespace Profile.DataAccess.Migrations
{
    ...
    [Migration("20260525080820_AddProfileProfileViews")]
    partial class AddProfileProfileViews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile.DataAccess.Entities.ProfileView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProfileOwnerId", "ViewedAt")
                        .HasDatabaseName("IX_profile_views_profile_owner_id_viewed_at");

                    b.ToTable("profile_views", "profile");
                });
