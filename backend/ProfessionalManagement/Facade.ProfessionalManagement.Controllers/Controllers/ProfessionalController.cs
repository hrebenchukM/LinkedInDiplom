...
public class ProfessionalController : ControllerBase
{
    ...
    {
        var skill = await _professionalManagementService.GetSkillByIdAsync(skillId);
    ...
    public async Task<IActionResult> CreateSkill([FromBody] CreateSkillRequest request)
    {
        ...
        var response = await _professionalManagementService.CreateSkillAsync(request);
    ...
    public async Task<IActionResult> GetMyUserSkills()
    {
        ...
        var userSkills = await _professionalManagementService.GetMyUserSkillsAsync(userId);
    ...
    public async Task<IActionResult> GetMyUserSkillById(Guid userSkillId)
    {
        ...
        var userSkill = await _professionalManagementService.GetMyUserSkillByIdAsync(
            userId,
            userSkillId);
    ...
    public async Task<IActionResult> CreateMyUserSkill([FromBody] CreateUserSkillRequest request)
    {
        ...
        var response = await _professionalManagementService.CreateMyUserSkillAsync(
            userId,
            request);
        ...
        [FromBody] UpdateUserSkillRequest request)
    {
        ...
        var response = await _professionalManagementService.UpdateMyUserSkillAsync(
            userId,
            userSkillId,
            request);
        ...
        [FromBody] PatchUserSkillRequest request)
    {
        ...
        var response = await _professionalManagementService.PatchMyUserSkillAsync(
            userId,
            userSkillId,
            request);
    ...
    public async Task<IActionResult> DeleteMyUserSkill(Guid userSkillId)
    {
        ...
        var response = await _professionalManagementService.DeleteMyUserSkillAsync(
            userId,
            userSkillId);
    ...
    {
        var language = await _professionalManagementService.GetLanguageByIdAsync(languageId);
    ...
    public async Task<IActionResult> CreateLanguage([FromBody] CreateLanguageRequest request)
    {
        ...
        var response = await _professionalManagementService.CreateLanguageAsync(request);
    ...
    public async Task<IActionResult> GetMyUserLanguages()
    {
        ...
        var userLanguages = await _professionalManagementService.GetMyUserLanguagesAsync(userId);
    ...
    public async Task<IActionResult> GetMyUserLanguageById(Guid userLanguageId)
    {
        ...
        var userLanguage = await _professionalManagementService.GetMyUserLanguageByIdAsync(
            userId,
            userLanguageId);
    ...
    public async Task<IActionResult> CreateMyUserLanguage([FromBody] CreateUserLanguageRequest request)
    {
        ...
        var response = await _professionalManagementService.CreateMyUserLanguageAsync(
            userId,
            request);
        ...
        [FromBody] UpdateUserLanguageRequest request)
    {
        ...
        var response = await _professionalManagementService.UpdateMyUserLanguageAsync(
            userId,
            userLanguageId,
            request);
        ...
        [FromBody] PatchUserLanguageRequest request)
    {
        ...
        var response = await _professionalManagementService.PatchMyUserLanguageAsync(
            userId,
            userLanguageId,
            request);
